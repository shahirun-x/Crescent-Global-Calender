...
insert into public.institutions
  (id, name, location, city, established_year, category, description, external_url, latitude, longitude, sort_order)
values
  ('crescent-residential-boys-school','Crescent Residential Boys Matriculation School','Seethakathi Nagar, Chennai','Chennai',1967,'education','The founding institution of the Crescent movement — a residential matriculation school in Chennai since 1967.','https://www.crescentschools.edu.in',13.0475,80.2090,1),
  ('crescent-girls-school','Crescent Girls Matriculation School','Chennai','Chennai',1976,'education','A matriculation school for girls in Chennai, extending Crescent''s commitment to education for young women.','https://www.crescentschools.edu.in',13.0480,80.2085,2),
  ('bsa-crescent-institute','B.S. Abdur Rahman Crescent Institute of Science & Technology','Vandalur, Chennai','Chennai',1984,'education','A deemed-to-be university offering engineering, sciences, management, law and Islamic studies.','https://crescent.education',12.8231,80.0424,3),
  ('crescent-innovation-incubation-centre','Crescent Innovation & Incubation Centre (CIIC)','Vandalur, Chennai','Chennai',2017,'innovation','A technology business incubator supporting student and community startups.','https://ciic.io',12.8235,80.0428,4),
  ('tbak-college-women','Thassim Beevi Abdul Kader College for Women','Kilakarai, Ramanathapuram','Kilakarai',1988,'education','An arts and science college for women in Kilakarai.','https://tbak.ac.in',9.2312,78.7834,5),
  ('muthu-zulaikha-public-school','Muthu Zulaikha Public School','Kilakarai, Ramanathapuram','Kilakarai',1993,'education','A CBSE school in Kilakarai providing English-medium schooling.','',9.2320,78.7840,6),
  ('yousuf-zulaikha-hospital','Yousuf Zulaikha Hospital','Kilakarai, Ramanathapuram','Kilakarai',1987,'healthcare','A multi-speciality hospital serving Kilakarai and surrounding villages.','',9.2315,78.7830,7),
  ('crescent-school-vandalur','Crescent School (CBSE & IGCSE)','Vandalur, Chennai','Chennai',2013,'education','A co-educational school offering both CBSE and Cambridge IGCSE curricula.','https://www.crescentschools.edu.in',12.8240,80.0430,8),
  ('crescent-college-education-madurai','Crescent College of Education','Madurai','Madurai',2005,'education','A teacher-education college in Madurai.','https://crescentcollegeofeducation.in',9.9252,78.1198,9),
  ('crescent-yz-school-nursing-madurai','Crescent Yousuf Zulaikha School of Nursing','Madurai','Madurai',2008,'healthcare','A nursing school in Madurai training healthcare professionals.','https://crescentschoolofnursing.in',9.9260,78.1195,10),
  ('buhari-aalim-arabic-college','Buhari Aalim Arabic College','Chennai','Chennai',null,'education','An Arabic and Islamic studies college in Chennai.','http://albukhari.in',13.0470,80.2095,11),
  ('madurai-crescent-school','Madurai Crescent School','Madurai','Madurai',null,'education','A Crescent school serving families in and around Madurai.','',9.9255,78.1200,12),
  ('nagore-crescent-school','Nagore Crescent School','Nagore, Nagapattinam','Nagore',null,'education','A Crescent school in the coastal town of Nagore.','',10.8240,79.8420,13),
  ('pearl-matriculation-school','Pearl Matriculation School','Kilakarai, Ramanathapuram','Kilakarai',1993,'education','A matriculation school in Kilakarai focused on foundational learning.','http://www.pearlschool.ac.in',9.2318,78.7838,14),
  ('childrens-homes-community-initiatives','Children''s Homes & Community Initiatives','Multiple locations across Tamil Nadu','Multiple',null,'community','Residential children''s homes, orphan care, scholarships and welfare programmes.','',9.2325,78.7845,15)
