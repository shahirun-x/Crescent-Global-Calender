...
values
  ...
  ('yousuf-zulaikha-hospital','Yousuf Zulaikha Hospital','Kilakarai, Ramanathapuram','Kilakarai',null,'healthcare','A multi-speciality hospital serving Kilakarai and surrounding villages.','',7),
  ...
  ('crescent-college-education-madurai','Crescent College of Education','Madurai','Madurai',2005,'education','A teacher-education college in Madurai.','',9),
  ('crescent-yz-school-nursing-madurai','Crescent Yousuf Zulaikha School of Nursing','Madurai','Madurai',2008,'healthcare','A nursing school in Madurai training healthcare professionals.','',10),
  ('buhari-aalim-arabic-college','Buhari Aalim Arabic College','Chennai','Chennai',null,'education','An Arabic and Islamic studies college in Chennai.','',11),
  ...
  ('pearl-matriculation-school','Pearl Matriculation School','Kilakarai, Ramanathapuram','Kilakarai',null,'education','A matriculation school in Kilakarai focused on foundational learning.','',14),
