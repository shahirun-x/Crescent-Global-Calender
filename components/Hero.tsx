...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-crescent-700 text-white">
      <div
        aria-hidden
      ...
      />
      <div className="container-page relative grid gap-10 py-20 md:py-28 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div>
